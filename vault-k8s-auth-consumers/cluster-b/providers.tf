# Provider Configuration para Cluster-B
# Este proyecto se ejecuta en el contexto del cluster-b
...
# Provider de AWS
# ⚠️ IMPORTANTE: Configurar credenciales para la cuenta AWS del cluster-b
